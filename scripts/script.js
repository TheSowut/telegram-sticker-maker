...
window.addEventListener('load', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        el = document.querySelector('.drop_zone');
        el.addEventListener('dragover', function () { return el.classList.add('on-dragover'); });
        el.addEventListener('dragleave', function () { return el.classList.remove('on-dragover'); });
        el.addEventListener('drop', function () { return el.classList.remove('on-dragover'); });
        return [2 /*return*/];
    });
}); });
